          ...
          <Box component="form" sx={{ p: 3 }} noValidate id="resume-form" onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth margin='normal'>
              ...
              <Select labelId='state-select-label' id='state-select' value={st} label='st' onChange={(e) => { setSt(e.target.value) }}>
                ...
                <MenuItem value="Sudurpashchim">Sudurpashchim</MenuItem>
              </Select>
            </FormControl>
            <FormControl fullWidth margin='normal'>
            ...
            <FormControl component='fieldset' fullWidth margin='normal'>
              ...
              <FormGroup row>
                ...
                <FormControlLabel control={<Checkbox />} label="Kathmandu" value="Kathmandu" onChange={(e) => getPjl(e)} />
                <FormControlLabel control={<Checkbox />} label="Butwal" value="Butwal" onChange={(e) => getPjl(e)} />
                <FormControlLabel control={<Checkbox />} label="Biratnagar" value="Biratnagar" onChange={(e) => getPjl(e)} />
                <FormControlLabel control={<Checkbox />} label="Dhangadi" value="Dhangadi" onChange={(e) => getPjl(e)} />
              </FormGroup>
            </FormControl>
